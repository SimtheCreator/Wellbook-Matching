...
// Global Script Logic
        ...
        // Range: -5 to +5
        const clinicalData = [
            { id: "pilates", name: "Reformer Pilates", type: "onsite", env: "studio", icon: "🤸‍♀️", pubmed: "PMID: 22375213", mechanism: "Controlled eccentric contractions target deep-trunk musculature, improving lumbo-pelvic stability.", description: { th: "พิลาทิสบนเครื่องรีฟอร์เมอร์ แก้ออฟฟิศซินโดรม สร้างกล้ามเนื้อแกนกลาง", en: "Reformer Pilates for office syndrome and core strength" }, veto: ["joint_injury"], vector: { p: 3, m: 1, s: 2, n: 0, g: 2 }, bestTime: ['afterwork', 'weekend'] },
            { id: "onsen", name: "Onsen & Hot Springs", type: "onsite", env: "indoor", icon: "♨️", pubmed: "PMID: 29882782", mechanism: "Thermal stress triggers Heat Shock Factor 1 (HSF1), producing systemic anti-inflammatory effects.", description: { th: "แช่น้ำแร่ร้อน ลดปวดเมื่อย กระตุ้นการไหลเวียนเลือดและฮอร์โมนฟื้นฟู", en: "Hot springs to reduce aches, boost circulation and recovery hormones" }, veto: ["heart_risk"], vector: { p: -4, m: -3, s: -4, n: 0, g: -2 }, bestTime: ['afterwork', 'weekend'] },
            { id: "sound_bath", name: "Sound Bath", type: "any", env: "indoor", icon: "🧘", pubmed: "PMID: 36826208", mechanism: "Low-frequency acoustic vibrations stimulate the vagus nerve and promote parasympathetic dominance.", description: { th: "บำบัดด้วยคลื่นเสียงความถี่ต่ำ ดึงสมองสู่ความสงบขั้นสุด ลดความเครียด", en: "Low-frequency sound therapy for ultimate calm and stress relief" }, veto: ["sensory"], vector: { p: -4, m: -5, s: -3, n: 2, g: 1 }, bestTime: ['afterwork', 'weekend'] },
            { id: "ice_bath", name: "Ice Baths / Cold Plunge", type: "onsite", env: "studio", icon: "🧊", pubmed: "PMID: 24799686", mechanism: "Cold water immersion spikes epinephrine, upregulating anti-inflammatory cytokines.", description: { th: "แช่น้ำแข็งฟื้นฟูกล้ามเนื้อเฉียบพลัน กระตุ้นภูมิคุ้มกันและปลุกพลังใจ", en: "Ice baths for acute muscle recovery, immunity, and mental toughness" }, veto: ["heart_risk"], vector: { p: 2, m: 2, s: -4, n: 4, g: 3 }, bestTime: ['afterwork', 'weekend', 'morning'] },
            { id: "muaythai", name: "Muay Thai / HIIT", type: "any", env: "studio", icon: "🥊", pubmed: "PMID: 35547204", mechanism: "High-intensity mechanical loading stimulates osteoblast activity via Wolff's Law.", description: { th: "คาร์ดิโอความเข้มข้นสูง ระบายความเครียด เผาผลาญไขมัน", en: "High-intensity cardio to relieve stress and burn fat" }, veto: ["heart_risk", "joint_injury"], vector: { p: 5, m: 2, s: 3, n: 1, g: 3 }, bestTime: ['afterwork', 'weekend'] },
            { id: "clay_art", name: "Pottery & Clay Art", type: "onsite", env: "indoor", icon: "🏺", pubmed: "PMID: 28730717", mechanism: "Bilateral tactile stimulation engages the somatosensory cortex and facilitates emotion regulation.", description: { th: "เวิร์กชอปปั้นดินเผา ฝึกสมาธิ ดึงสมองเข้าสู่ Flow State", en: "Pottery workshop to practice mindfulness and enter a Flow State" }, veto: [], vector: { p: -2, m: -2, s: 2, n: 4, g: 1 }, bestTime: ['weekend'] },
            { id: "yoga", name: "Restorative Yoga", type: "any", env: "indoor", icon: "🧘‍♀️", pubmed: "PMID: 32240757", mechanism: "Sustained stretching decreases sympathetic tone and significantly improves HRV metrics.", description: { th: "โยคะยืดเหยียดช้าๆ เน้นลมหายใจ ช่วยให้ระบบประสาทผ่อนคลาย", en: "Slow stretching yoga focusing on breath to relax the nervous system" }, veto: [], vector: { p: -3, m: -4, s: 1, n: 0, g: 1 }, bestTime: ['afterwork', 'weekend', 'morning'] },
            { id: "business", name: "Business Workshop", type: "onsite", env: "studio", icon: "📈", pubmed: "PMID: 11148302", mechanism: "Fulfills psychological needs for competence and relatedness, buffering against existential burnout.", description: { th: "คลาสสอนธุรกิจ หาคอนเนคชัน (เช่น Pitching Event)", en: "Business classes for networking (e.g., Pitching Events)" }, veto: [], vector: { p: 0, m: 5, s: 5, n: 2, g: 5 }, bestTime: ['weekend'] },
            { id: "selfdev", name: "Self-Development", type: "any", env: "indoor", icon: "🧠", pubmed: "PMID: 24192560", mechanism: "Cognitive engagement increases neural plasticity and builds cognitive reserve against stress.", description: { th: "เวิร์กชอปพัฒนาตัวเอง (เช่น Enneagram, Vision Board)", en: "Self-development workshops (e.g., Enneagram, Vision Board)" }, veto: [], vector: { p: -1, m: 4, s: 3, n: 2, g: 5 }, bestTime: ['weekend'] },
            { id: "boardgame", name: "Board Game Club", type: "onsite", env: "studio", icon: "🎲", pubmed: "PMID: 25910392", mechanism: "Positive social interaction releases oxytocin, reducing cortisol and mitigating social isolation risks.", description: { th: "คอมมูนิตี้บอร์ดเกม พบปะพูดคุย เสียงหัวเราะบำบัดจิตใจ", en: "Board game community to meet, talk, and heal through laughter" }, veto: [], vector: { p: -1, m: 2, s: 5, n: 3, g: 0 }, bestTime: ['afterwork', 'weekend'] },
            { id: "park_walk", name: "Forest Bathing / Park Walk", type: "onsite", env: "nature", icon: "🌳", pubmed: "PMID: 19568835", mechanism: "Exposure to phytoncides in green spaces lowers cortisol levels and reduces blood pressure.", description: { th: "เดินเล่นรับพื้นที่สีเขียว อาบป่า (Forest Bathing) ลดความเครียดสะสม", en: "Mindful park walks to lower cortisol through nature exposure" }, veto: [], vector: { p: 0, m: -3, s: -2, n: 1, g: 1 }, bestTime: ['weekend', 'morning', 'afterwork'] },
            { id: "run_club", name: "Urban Run Club", type: "onsite", env: "nature", icon: "🏃‍♂️", pubmed: "PMID: 29241517", mechanism: "Cardiovascular exercise combined with social interaction boosts endorphin and oxytocin release.", description: { th: "ชมรมวิ่งในสวนสาธารณะ ได้ทั้งสุขภาพดีและมิตรภาพใหม่", en: "Outdoor run club for fitness and community networking" }, veto: ["heart_risk", "joint_injury"], vector: { p: 4, m: 2, s: 4, n: 1, g: 1 }, bestTime: ['afterwork', 'morning'] },
            { id: "sup_board", name: "SUP Board / Water Sports", type: "onsite", env: "nature", icon: "🏄‍♀️", pubmed: "PMID: 31221191", mechanism: "Balances proprioception and core stability while exposure to blue space reduces mental fatigue.", description: { th: "พายซับบอร์ดรับลมเย็นๆ ฝึกบาลานซ์ร่างกายบนผิวน้ำ", en: "Stand-Up Paddleboarding for core balance and mental refreshment" }, veto: ["joint_injury"], vector: { p: 3, m: -2, s: 2, n: 4, g: 1 }, bestTime: ['weekend', 'morning'] }
        ];
        ...
        function restoreUIState() {
            ...
            if (state.vitals.stress) {
                ...
                if(stressTextEl) {
                    ...
                    stressTextEl.innerHTML = `<span class="text-wellnista-olive font-bold"><span class="lang-th">ระดับ</span><span class="lang-en">Level</span> ${state.vitals.stress}:</span> ${descMap[state.vitals.stress]}`;
                }
            }
        ...
        function selectSingle(group, val, el, category = null) {
            ...
            if (group === 'stress') {
                ...
                if(stressTextEl) {
                    stressTextEl.classList.remove('hidden');
                    stressTextEl.innerHTML = `<span class="text-wellnista-olive font-bold"><span class="lang-th">ระดับ</span><span class="lang-en">Level</span> ${val}:</span> ${descMap[val]}`;
                }
            }
        ...
        function calculateMatch() {
            ...
            clinicalData.forEach(act => {
                ...
                if(state.env && state.env === act.env) score += 2;

                // Logistics Penalty (Time & Access) - -5% penalty for flexibility
                if(act.bestTime && state.time) {
                    if (state.time === 'random') {
                        if (act.type === 'onsite') score -= 5;
                    } else if (!act.bestTime.includes(state.time)) {
                        score -= 5;
                    }
                }

                if (state.access === 'rarely' && act.type === 'onsite') {
                    score -= 5;
                }
        ...
        function processUserChoice() {
            if (typeof saveAssessmentAnonymous === 'function') {
                saveAssessmentAnonymous(state).then(id => {
    ...
    <div className="w-full h-full md:w-[414px] md:h-[896px] md:max-h-[95dvh] bg-wellnista-bg md:rounded-[40px] premium-shadow relative flex flex-col overflow-hidden border border-[#e8e5df]/50 mobile-container">
        ...
        <header className="py-3 px-4 text-center border-b border-[#e8e5df] flex-shrink-0 z-10 bg-white/80 backdrop-blur-md relative flex flex-col justify-center items-center">
            <button onClick={(e) => resetApp()} className="absolute top-1/2 -translate-y-1/2 right-4 text-wellnista-sand hover:text-wellnista-olive transition-colors flex flex-col items-center" title="Change Language / Restart">
                ...
                <span className="text-[8px] mt-0.5 font-medium tracking-wider"><span className="lang-th">เปลี่ยนภาษา</span><span className="lang-en">LANG</span></span>
            </button>
            <div className="cursor-pointer flex flex-col items-center justify-center relative w-full" onClick={(e) => resetApp()}>
                <div className="relative inline-flex items-baseline justify-center">
                    <span className="text-2xl md:text-3xl font-bold font-serif text-wellnista-olive tracking-tight leading-none">WellBook</span>
                    <span className="absolute left-full bottom-[2px] ml-1.5 text-[10px] md:text-[11px] text-wellnista-sand font-serif italic leading-none whitespace-nowrap">by Wellnista</span>
                </div>
                <div className="text-[8px] md:text-[9px] text-wellnista-sage font-mono tracking-[0.2em] uppercase mt-1.5">Wellness & Community</div>
            </div>
        </header>
        ...
        <main className="flex-1 overflow-y-auto p-5 md:p-6 flex flex-col relative pb-8" id="app-container">
            ...
            <div id="step-0" className="step active flex-col justify-center items-center flex-1 min-h-full pb-10">
                ...
                <div className="w-full space-y-5 px-2">
                    <button onClick={(e) => {selectLang('th')}} className="w-full bg-white border border-wellnista-border hover:border-wellnista-olive text-wellnista-textDark font-medium py-5 rounded-3xl transition-all flex items-center justify-center gap-3">
                        <span className="text-[16px] font-serif tracking-widest text-wellnista-olive">ภาษาไทย</span>
                    </button>
                    <button onClick={(e) => {selectLang('en')}} className="w-full bg-white border border-wellnista-border hover:border-wellnista-olive text-wellnista-textDark font-medium py-5 rounded-3xl transition-all flex items-center justify-center gap-3">
                        <span className="text-[16px] font-serif tracking-widest text-wellnista-olive uppercase">English</span>
                    </button>
                </div>
            ...
            <div id="step-1" className="step flex-col flex-1 hidden">
                ...
                <h2 className="text-xl md:text-2xl font-semibold mb-2 tracking-tight text-wellnista-textDark"><span className="lang-th">ข้อมูลพื้นฐานของคุณ</span><span className="lang-en">Your Basic Profile</span></h2>
                <p className="text-wellnista-textMuted text-xs mb-6 font-light leading-relaxed"><span className="lang-th">เพื่อให้ระบบปรับแต่งการประเมินให้เหมาะสมกับคุณที่สุด</span><span className="lang-en">To help us tailor the assessment to you</span></p>
                
                <h3 className="text-[10px] font-medium text-wellnista-textMuted mb-2 tracking-wide uppercase"><span className="lang-th">1. เพศ (Gender)</span><span className="lang-en">1. Gender</span></h3>
                <div className="grid grid-cols-3 gap-2 mb-6" id="q-gender">
                    <button onClick={(e) => {selectSingle('gender', 'female', e.currentTarget)}} className="option-btn p-3 rounded-2xl flex flex-col items-center gap-2">
                        <i data-lucide="user" className="w-5 h-5 text-wellnista-sage"></i><span className="text-[11px] font-medium"><span className="lang-th">หญิง</span><span className="lang-en">Female</span></span>
                    </button>
                    <button onClick={(e) => {selectSingle('gender', 'male', e.currentTarget)}} className="option-btn p-3 rounded-2xl flex flex-col items-center gap-2">
                        <i data-lucide="user" className="w-5 h-5 text-wellnista-sage"></i><span className="text-[11px] font-medium"><span className="lang-th">ชาย</span><span className="lang-en">Male</span></span>
                    </button>
                    <button onClick={(e) => {selectSingle('gender', 'other', e.currentTarget)}} className="option-btn p-3 rounded-2xl flex flex-col items-center gap-2">
                        <i data-lucide="users" className="w-5 h-5 text-wellnista-sage"></i><span className="text-[11px] font-medium"><span className="lang-th">ไม่ระบุ</span><span className="lang-en">Other</span></span>
                    </button>
                </div>

                <h3 className="text-[10px] font-medium text-wellnista-textMuted mb-2 tracking-wide uppercase"><span className="lang-th">2. ช่วงอายุ (Age Range)</span><span className="lang-en">2. Age Range</span></h3>
                <div className="grid grid-cols-3 gap-2 mb-6" id="q-age">
                    ...
                    <button onClick={(e) => {selectSingle('age', '55+', e.currentTarget)}} className="option-btn p-2 rounded-xl text-[11px] font-medium text-center col-span-2"><span className="lang-th">55 ปีขึ้นไป</span><span className="lang-en">55+</span></button>
                </div>

                <h3 className="text-[10px] font-medium text-wellnista-textMuted mb-2 tracking-wide uppercase"><span className="lang-th">3. รูปแบบการทำงาน (Work Style)</span><span className="lang-en">3. Work Style</span></h3>
                <div className="grid grid-cols-2 gap-2 mb-6" id="q-work">
                    <button onClick={(e) => {selectSingle('work', 'corporate', e.currentTarget)}} className="option-btn p-3 rounded-2xl flex items-center gap-2">
                        <i data-lucide="building" className="w-4 h-4 text-wellnista-sand"></i><span className="text-[11px] font-medium"><span className="lang-th">พนักงานบริษัท</span><span className="lang-en">Corporate</span></span>
                    </button>
                    <button onClick={(e) => {selectSingle('work', 'freelance', e.currentTarget)}} className="option-btn p-3 rounded-2xl flex items-center gap-2">
                        <i data-lucide="laptop" className="w-4 h-4 text-wellnista-sand"></i><span className="text-[11px] font-medium"><span className="lang-th">ทำงานอิสระ / WFH</span><span className="lang-en">Freelance / WFH</span></span>
                    </button>
                    <button onClick={(e) => {selectSingle('work', 'entrepreneur', e.currentTarget)}} className="option-btn p-3 rounded-2xl flex items-center gap-2">
                        <i data-lucide="briefcase" className="w-4 h-4 text-wellnista-sand"></i><span className="text-[11px] font-medium"><span className="lang-th">เจ้าของธุรกิจ</span><span className="lang-en">Entrepreneur</span></span>
                    </button>
                    <button onClick={(e) => {selectSingle('work', 'student', e.currentTarget)}} className="option-btn p-3 rounded-2xl flex items-center gap-2">
                        <i data-lucide="graduation-cap" className="w-4 h-4 text-wellnista-sand"></i><span className="text-[11px] font-medium"><span className="lang-th">นักศึกษา</span><span className="lang-en">Student</span></span>
                    </button>
                    <button onClick={(e) => {selectSingle('work', 'healthcare', e.currentTarget)}} className="option-btn p-3 rounded-2xl flex items-center gap-2">
                        <i data-lucide="heart-pulse" className="w-4 h-4 text-wellnista-sand"></i><span className="text-[11px] font-medium"><span className="lang-th">สายแพทย์/สาธารณสุข</span><span className="lang-en">Healthcare</span></span>
                    </button>
                    <button onClick={(e) => {selectSingle('work', 'creative', e.currentTarget)}} className="option-btn p-3 rounded-2xl flex items-center gap-2">
                        <i data-lucide="palette" className="w-4 h-4 text-wellnista-sand"></i><span className="text-[11px] font-medium"><span className="lang-th">สายอาร์ต/ครีเอทีฟ</span><span className="lang-en">Creative</span></span>
                    </button>
                    <button onClick={(e) => {selectSingle('work', 'service', e.currentTarget)}} className="option-btn p-3 rounded-2xl flex items-center gap-2">
                        <i data-lucide="coffee" className="w-4 h-4 text-wellnista-sand"></i><span className="text-[11px] font-medium"><span className="lang-th">งานบริการ/ค้าขาย</span><span className="lang-en">Service</span></span>
                    </button>
                    <button onClick={(e) => {selectSingle('work', 'other', e.currentTarget)}} className="option-btn p-3 rounded-2xl flex items-center gap-2">
                        <i data-lucide="users" className="w-4 h-4 text-wellnista-sand"></i><span className="text-[11px] font-medium"><span className="lang-th">อื่นๆ</span><span className="lang-en">Others</span></span>
                    </button>
                </div>

                <div className="mt-auto pt-4">
                    <button onClick={(e) => {nextStep(2)}} id="btn-next-1" className="w-full bg-wellnista-olive hover:bg-wellnista-oliveDark text-white font-medium py-4 rounded-[20px] shadow-md disabled:opacity-40 disabled:shadow-none transition-all duration-300 flex justify-center items-center gap-2"><span className="lang-th">เริ่มทำแบบประเมิน</span><span className="lang-en">Start Assessment</span> <i data-lucide="arrow-right" className="w-4 h-4"></i></button>
                </div>
            </div>
            ...
            <div id="step-2" className="step flex-col flex-1 hidden">
                ...
                <h2 className="text-xl md:text-2xl font-semibold mb-2 tracking-tight text-wellnista-textDark"><span className="lang-th">คุณรู้สึกอย่างไรในสัปดาห์นี้?</span><span className="lang-en">How are you feeling this week?</span></h2>
                <p className="text-wellnista-textMuted text-xs mb-6 font-light leading-relaxed"><span className="lang-th">สำรวจร่างกายและจิตใจอย่างนุ่มนวล</span><span className="lang-en">Gently explore your body and mind</span></p>
                
                <h3 className="text-[10px] font-medium text-wellnista-textMuted mb-2 tracking-wide uppercase"><span className="lang-th">1. สภาพร่างกาย (Physical State)</span><span className="lang-en">1. Physical State</span></h3>
                <div className="grid grid-cols-2 gap-2 mb-5" id="q-physical">
                    <button onClick={(e) => {selectSingle('physical', 'pain', e.currentTarget)}} className="option-btn p-3 rounded-2xl flex flex-col items-center gap-2 text-center">
                        ...
                        <span className="text-[11px] font-medium"><span className="lang-th">ออฟฟิศซินโดรม</span><span className="lang-en">Office Syndrome</span></span>
                    </button>
                    <button onClick={(e) => {selectSingle('physical', 'fatigue', e.currentTarget)}} className="option-btn p-3 rounded-2xl flex flex-col items-center gap-2 text-center">
                        ...
                        <span className="text-[11px] font-medium"><span className="lang-th">ล้ากล้ามเนื้อ</span><span className="lang-en">Muscle Fatigue</span></span>
                    </button>
                    <button onClick={(e) => {selectSingle('physical', 'normal', e.currentTarget)}} className="option-btn p-3 rounded-2xl flex flex-col items-center gap-2 text-center col-span-2">
                        ...
                        <span className="text-[11px] font-medium"><span className="lang-th">ร่างกายปกติดี แต่อยากฟิตขึ้น</span><span className="lang-en">Healthy & Normal, want to be fitter</span></span>
                    </button>
                </div>

                <h3 className="text-[10px] font-medium text-wellnista-textMuted mb-2 tracking-wide uppercase"><span className="lang-th">2. สภาวะจิตใจ (Mental State)</span><span className="lang-en">2. Mental State</span></h3>
                <div className="grid grid-cols-2 gap-2 mb-5" id="q-mental">
                    <button onClick={(e) => {selectSingle('mental', 'stress', e.currentTarget)}} className="option-btn p-3 rounded-2xl flex items-center gap-2">
                        <i data-lucide="cloud" className="w-5 h-5 text-wellnista-sage"></i><span className="text-[11px] font-medium"><span className="lang-th">เครียดสะสม</span><span className="lang-en">Chronic Stress</span></span>
                    </button>
                    <button onClick={(e) => {selectSingle('mental', 'insomnia', e.currentTarget)}} className="option-btn p-3 rounded-2xl flex items-center gap-2">
                        <i data-lucide="moon" className="w-5 h-5 text-wellnista-sage"></i><span className="text-[11px] font-medium"><span className="lang-th">นอนไม่หลับ</span><span className="lang-en">Insomnia</span></span>
                    </button>
                    <button onClick={(e) => {selectSingle('mental', 'burnout', e.currentTarget)}} className="option-btn p-3 rounded-2xl flex items-center gap-2">
                        <i data-lucide="wind" className="w-5 h-5 text-wellnista-sage"></i><span className="text-[11px] font-medium"><span className="lang-th">หมดไฟ</span><span className="lang-en">Burnout</span></span>
                    </button>
                    <button onClick={(e) => {selectSingle('mental', 'normal', e.currentTarget)}} className="option-btn p-3 rounded-2xl flex items-center gap-2">
                        <i data-lucide="sun" className="w-5 h-5 text-wellnista-sage"></i><span className="text-[11px] font-medium"><span className="lang-th">แจ่มใสปกติ</span><span className="lang-en">Clear & Fresh</span></span>
                    </button>
                </div>

                <h3 className="text-[10px] font-medium text-wellnista-textMuted mb-2 tracking-wide uppercase"><span className="lang-th">3. หากไม่ได้ฟื้นฟู จะเกิดอะไรขึ้น?</span><span className="lang-en">3. If not recovered, what happens?</span></h3>
                <div className="grid grid-cols-1 gap-2 mb-4" id="q-negative">
                    ...
                    <button onClick={(e) => {selectSingle('negative', 'mood', e.currentTarget)}} className="option-btn p-3 rounded-2xl flex items-center gap-3 text-left">
                        ...
                        <div className="font-medium text-[11px]"><span className="lang-th">อารมณ์แปรปรวน หงุดหงิดง่าย</span><span className="lang-en">Mood swings, easily irritated</span></div>
                    </button>
                    <button onClick={(e) => {selectSingle('negative', 'aches', e.currentTarget)}} className="option-btn p-3 rounded-2xl flex items-center gap-3 text-left">
                        ...
                        <div className="font-medium text-[11px]"><span className="lang-th">ปวดเมื่อยทางกายรุนแรงขึ้น</span><span className="lang-en">Severe physical aches</span></div>
                    </button>
                    <button onClick={(e) => {selectSingle('negative', 'normal', e.currentTarget)}} className="option-btn p-3 rounded-2xl flex items-center gap-3 text-left">
                        ...
                        <div className="font-medium text-[11px]"><span className="lang-th">ใช้ชีวิตปกติได้เรื่อยๆ ไม่มีผลกระทบมาก</span><span className="lang-en">Normal, no major impact</span></div>
                    </button>
                </div>

                <div className="flex gap-2 mt-auto pt-4">
                    <button onClick={(e) => {nextStep(1)}} className="w-1/3 bg-white border border-wellnista-border text-wellnista-textDark font-medium py-3 rounded-[20px] hover:bg-slate-50 transition-colors"><span className="lang-th">กลับ</span><span className="lang-en">Back</span></button>
                    <button onClick={(e) => {nextStep(3)}} id="btn-next-2" className="w-2/3 bg-wellnista-olive hover:bg-wellnista-oliveDark text-white font-medium py-3 rounded-[20px] shadow-md disabled:opacity-40 disabled:shadow-none transition-all flex justify-center items-center gap-2"><span className="lang-th">ถัดไป</span><span className="lang-en">Next</span> <i data-lucide="arrow-right" className="w-4 h-4"></i></button>
                </div>
            </div>
            ...
            <div id="step-3" className="step flex-col flex-1 hidden">
                ...
                <h2 className="text-xl md:text-2xl font-semibold mb-2 tracking-tight text-wellnista-textDark"><span className="lang-th">ตัวชี้วัดสุขภาพ</span><span className="lang-en">Health Metrics</span></h2>
                <p className="text-wellnista-textMuted text-xs mb-6 font-light"><span className="lang-th">ข้อมูลเหล่านี้ช่วยเราประเมินความปลอดภัยและสรีรวิทยาของคุณ</span><span className="lang-en">These help us assess your safety and physiology</span></p>
                ...
                <div className="space-y-4">
                    <div className="bg-white p-4 rounded-[20px] border border-wellnista-border shadow-sm">
                        <label className="flex justify-between text-xs mb-3 font-medium text-wellnista-textDark">
                            <span className="flex items-center gap-2"><i data-lucide="heart-pulse" className="w-4 h-4 text-wellnista-olive"></i> <span className="lang-th">จังหวะชีพจรขณะพัก (Resting HR)</span><span className="lang-en">Resting Heart Rate</span></span>
                        </label>
                        <div className="grid grid-cols-2 gap-2" id="q-rhr">
                            <button onClick={(e) => {selectSingle('rhr', 'low', e.currentTarget, 'vitals')}} className="option-btn p-2.5 rounded-xl text-center text-[10px] font-medium"><span className="lang-th">&lt; 60 bpm (เต้นช้า)</span><span className="lang-en">&lt; 60 bpm (Slow)</span></button>
                            <button onClick={(e) => {selectSingle('rhr', 'normal', e.currentTarget, 'vitals')}} className="option-btn p-2.5 rounded-xl text-center text-[10px] font-medium"><span className="lang-th">60-80 bpm (ปกติ)</span><span className="lang-en">60-80 bpm (Normal)</span></button>
                            <button onClick={(e) => {selectSingle('rhr', 'high', e.currentTarget, 'vitals')}} className="option-btn p-2.5 rounded-xl text-center text-[10px] font-medium"><span className="lang-th">81-99 bpm (เริ่มเร็ว)</span><span className="lang-en">81-99 bpm (Elevated)</span></button>
                            <button onClick={(e) => {selectSingle('rhr', 'veryhigh', e.currentTarget, 'vitals')}} className="option-btn p-2.5 rounded-xl text-center text-[10px] font-medium text-rose-600"><span className="lang-th">&gt; 100 bpm (เต้นเร็ว)</span><span className="lang-en">&gt; 100 bpm (Fast)</span></button>
                        </div>
                    </div>

                    <div className="bg-white p-4 rounded-[20px] border border-wellnista-border shadow-sm">
                        <label className="flex justify-between text-xs mb-3 font-medium text-wellnista-textDark">
                            <span className="flex items-center gap-2"><i data-lucide="clock" className="w-4 h-4 text-wellnista-olive"></i> <span className="lang-th">เวลานอนเฉลี่ย</span><span className="lang-en">Average Sleep Duration</span></span>
                        </label>
                        <div className="grid grid-cols-2 gap-2" id="q-sleep">
                            <button onClick={(e) => {selectSingle('sleep', 'less5', e.currentTarget, 'vitals')}} className="option-btn p-2.5 rounded-xl text-center text-[10px] font-medium text-rose-600"><span className="lang-th">น้อยกว่า 5 ชม.</span><span className="lang-en">Less than 5 hrs</span></button>
                            <button onClick={(e) => {selectSingle('sleep', '6to7', e.currentTarget, 'vitals')}} className="option-btn p-2.5 rounded-xl text-center text-[10px] font-medium"><span className="lang-th">6-7 ชม.</span><span className="lang-en">6-7 hrs</span></button>
                            <button onClick={(e) => {selectSingle('sleep', '7to8', e.currentTarget, 'vitals')}} className="option-btn p-2.5 rounded-xl text-center text-[10px] font-medium"><span className="lang-th">7-8 ชม.</span><span className="lang-en">7-8 hrs</span></button>
                            <button onClick={(e) => {selectSingle('sleep', 'more9', e.currentTarget, 'vitals')}} className="option-btn p-2.5 rounded-xl text-center text-[10px] font-medium"><span className="lang-th">9 ชม. ขึ้นไป</span><span className="lang-en">9+ hrs</span></button>
                        </div>
                    </div>

                    <div className="bg-white p-4 rounded-[20px] border border-wellnista-border shadow-sm">
                        <label className="flex justify-between text-xs mb-3 font-medium text-wellnista-textDark">
                            <span className="flex items-center gap-2"><i data-lucide="flame" className="w-4 h-4 text-wellnista-olive"></i> <span className="lang-th">ความถี่การออกกำลังกาย</span><span className="lang-en">Exercise Frequency</span></span>
                        </label>
                        <div className="grid grid-cols-2 gap-2" id="q-exercise">
                            <button onClick={(e) => {selectSingle('exercise', 'none', e.currentTarget, 'vitals')}} className="option-btn p-2.5 rounded-xl text-center text-[10px] font-medium"><span className="lang-th">ไม่ออกเลย</span><span className="lang-en">None</span></button>
                            <button onClick={(e) => {selectSingle('exercise', '1to2', e.currentTarget, 'vitals')}} className="option-btn p-2.5 rounded-xl text-center text-[10px] font-medium"><span className="lang-th">1-2 วัน/สัปดาห์</span><span className="lang-en">1-2 days/week</span></button>
                            <button onClick={(e) => {selectSingle('exercise', '3to4', e.currentTarget, 'vitals')}} className="option-btn p-2.5 rounded-xl text-center text-[10px] font-medium"><span className="lang-th">3-4 วัน/สัปดาห์</span><span className="lang-en">3-4 days/week</span></button>
                            <button onClick={(e) => {selectSingle('exercise', '5plus', e.currentTarget, 'vitals')}} className="option-btn p-2.5 rounded-xl text-center text-[10px] font-medium"><span className="lang-th">5 วันขึ้นไป/สัปดาห์</span><span className="lang-en">5+ days/week</span></button>
                        </div>
                    </div>

                    <div className="bg-white p-4 rounded-[20px] border border-wellnista-border shadow-sm">
                        <label className="flex justify-between text-xs mb-3 font-medium text-wellnista-textDark">
                            <span className="flex items-center gap-2"><i data-lucide="brain" className="w-4 h-4 text-wellnista-olive"></i> <span className="lang-th">ระดับความเครียด</span><span className="lang-en">Stress Level</span></span>
                        </label>
                ...
                <div className="flex gap-2 mt-auto pt-4">
                    <button onClick={(e) => {nextStep(2)}} className="w-1/3 bg-white border border-wellnista-border text-wellnista-textDark font-medium py-3 rounded-[20px] hover:bg-slate-50 transition-colors"><span className="lang-th">กลับ</span><span className="lang-en">Back</span></button>
            ...
            <div id="step-4" className="step flex-col flex-1 hidden">
                ...
                <h2 className="text-xl md:text-2xl font-semibold mb-2 tracking-tight text-wellnista-textDark"><span className="lang-th">ข้อจำกัดด้านสุขภาพ</span><span className="lang-en">Clinical Vetoes</span></h2>
                <p className="text-wellnista-textMuted text-xs mb-8 font-light"><span className="lang-th">เพื่อความปลอดภัย โปรดระบุอาการบาดเจ็บหรือโรคประจำตัว (PAR-Q+)</span><span className="lang-en">For safety, please indicate any medical conditions (PAR-Q+)</span></p>
                ...
                <div className="flex gap-2 mt-auto pt-4">
                    <button onClick={(e) => {nextStep(3)}} className="w-1/3 bg-white border border-wellnista-border text-wellnista-textDark font-medium py-3 rounded-[20px] hover:bg-slate-50 transition-colors"><span className="lang-th">กลับ</span><span className="lang-en">Back</span></button>
            ...
            <div id="step-5" className="step flex-col flex-1 hidden">
                ...
                <h2 className="text-xl md:text-2xl font-semibold mb-2 tracking-tight text-wellnista-textDark"><span className="lang-th">สไตล์ที่ใช่สำหรับคุณ?</span><span className="lang-en">What's your style?</span></h2>
                <p className="text-wellnista-textMuted text-xs mb-6 font-light"><span className="lang-th">จับคู่ความชอบที่ตรงกับบุคลิกภาพ</span><span className="lang-en">Match preferences to your personality</span></p>
                ...
                <h3 className="text-[10px] font-medium text-wellnista-textMuted mb-2 tracking-wide uppercase"><span className="lang-th">2. ความเปิดรับสิ่งใหม่ (Openness)</span><span className="lang-en">2. Openness to Experience</span></h3>
                <div className="grid grid-cols-3 gap-2 mb-4" id="q-openness">
                    <button onClick={(e) => {selectSingle('openness', 'low', e.currentTarget)}} className="option-btn p-2 rounded-xl text-[10px] font-medium text-center h-12"><span className="lang-th">ชอบแบบแผนเดิม</span><span className="lang-en">Prefer Routine</span></button>
                    <button onClick={(e) => {selectSingle('openness', 'mid', e.currentTarget)}} className="option-btn p-2 rounded-xl text-[10px] font-medium text-center h-12"><span className="lang-th">ปานกลาง</span><span className="lang-en">Moderate</span></button>
                    <button onClick={(e) => {selectSingle('openness', 'high', e.currentTarget)}} className="option-btn p-2 rounded-xl text-[10px] font-medium text-center h-12"><span className="lang-th">เปิดรับสิ่งใหม่ๆ</span><span className="lang-en">Open to New Things</span></button>
                </div>

                <h3 className="text-[10px] font-medium text-wellnista-textMuted mb-2 tracking-wide uppercase"><span className="lang-th">3. ระดับการเข้าสังคม (Social Level)</span><span className="lang-en">3. Social Level</span></h3>
                <div className="grid grid-cols-1 gap-2 mb-4" id="q-social">
                    <button onClick={(e) => {selectSingle('social', 'solo', e.currentTarget)}} className="option-btn p-3 rounded-2xl text-left text-[11px] font-medium flex items-center gap-2"><i data-lucide="user" className="w-4 h-4 text-wellnista-sand"></i> <span className="lang-th">ชอบทำคนเดียวเงียบๆ</span><span className="lang-en">Solo / Quiet</span></button>
                    <button onClick={(e) => {selectSingle('social', 'smallgroup', e.currentTarget)}} className="option-btn p-3 rounded-2xl text-left text-[11px] font-medium flex items-center gap-2"><i data-lucide="users" className="w-4 h-4 text-wellnista-sand"></i> <span className="lang-th">สบายใจกับกลุ่มเล็กๆ</span><span className="lang-en">Small Groups</span></button>
                    <button onClick={(e) => {selectSingle('social', 'networking', e.currentTarget)}} className="option-btn p-3 rounded-2xl text-left text-[11px] font-medium flex items-center gap-2"><i data-lucide="globe" className="w-4 h-4 text-wellnista-sand"></i> <span className="lang-th">ชอบพบปะผู้คนใหม่ๆ / คอนเนคชัน</span><span className="lang-en">Networking / Meeting People</span></button>
                </div>

                <div className="flex gap-2 mt-auto pt-2">
                    <button onClick={(e) => {nextStep(4)}} className="w-1/3 bg-white border border-wellnista-border text-wellnista-textDark font-medium py-3 rounded-[20px] hover:bg-slate-50 transition-colors"><span className="lang-th">กลับ</span><span className="lang-en">Back</span></button>
            ...
            <div id="step-6" className="step flex-col flex-1 hidden">
                ...
                <h2 className="text-xl md:text-2xl font-semibold mb-2 tracking-tight text-wellnista-textDark"><span className="lang-th">วิถีชีวิตและกิจวัตร</span><span className="lang-en">Lifestyle & Routine</span></h2>
                <p className="text-wellnista-textMuted text-xs mb-6 font-light"><span className="lang-th">เพื่อให้ AI หาโซลูชันที่เข้ากับตารางชีวิตของคุณได้อย่างราบรื่น</span><span className="lang-en">Let AI find a solution that fits your schedule</span></p>
                
                <h3 className="text-[10px] font-medium text-wellnista-textMuted mb-2 tracking-wide uppercase"><span className="lang-th">1. สภาพแวดล้อมที่ชอบ (Environment)</span><span className="lang-en">1. Preferred Environment</span></h3>
                <div className="grid grid-cols-1 gap-2 mb-4" id="q-env">
                    <button onClick={(e) => {selectSingle('env', 'nature', e.currentTarget)}} className="option-btn p-3 rounded-2xl text-left flex items-center gap-3"><i data-lucide="tree-pine" className="w-4 h-4 text-wellnista-sage"></i><span className="text-[11px] font-medium"><span className="lang-th">ธรรมชาติ / กลางแจ้ง</span><span className="lang-en">Nature / Outdoors</span></span></button>
                    <button onClick={(e) => {selectSingle('env', 'indoor', e.currentTarget)}} className="option-btn p-3 rounded-2xl text-left flex items-center gap-3"><i data-lucide="home" className="w-4 h-4 text-wellnista-sage"></i><span className="text-[11px] font-medium"><span className="lang-th">พื้นที่ปิดเงียบสงบ (เช่น สปา)</span><span className="lang-en">Quiet Indoor (e.g., Spa)</span></span></button>
                    <button onClick={(e) => {selectSingle('env', 'studio', e.currentTarget)}} className="option-btn p-3 rounded-2xl text-left flex items-center gap-3"><i data-lucide="users" className="w-4 h-4 text-wellnista-sage"></i><span className="text-[11px] font-medium"><span className="lang-th">สตูดิโอมีพลังงาน / เวิร์กชอป</span><span className="lang-en">Energetic Studio / Workshop</span></span></button>
                </div>

                <h3 className="text-[10px] font-medium text-wellnista-textMuted mb-2 tracking-wide uppercase"><span className="lang-th">2. ความสะดวกในการเดินทาง</span><span className="lang-en">2. Travel Convenience</span></h3>
                <div className="grid grid-cols-2 gap-2 mb-4" id="q-access">
                    <button onClick={(e) => {selectSingle('access', 'weekly', e.currentTarget)}} className="option-btn p-3 rounded-2xl text-center text-[11px] font-medium"><span className="lang-th">ไปได้ทุกสัปดาห์</span><span className="lang-en">Weekly</span></button>
                    <button onClick={(e) => {selectSingle('access', 'monthly', e.currentTarget)}} className="option-btn p-3 rounded-2xl text-center text-[11px] font-medium"><span className="lang-th">เดือนละ 1-2 ครั้ง</span><span className="lang-en">1-2 times/month</span></button>
                    <button onClick={(e) => {selectSingle('access', 'rarely', e.currentTarget)}} className="option-btn p-3 rounded-2xl text-center text-[11px] font-medium"><span className="lang-th">ไปได้นานๆ ครั้ง</span><span className="lang-en">Rarely</span></button>
                    <button onClick={(e) => {selectSingle('access', 'athome', e.currentTarget)}} className="option-btn p-3 rounded-2xl text-center text-[11px] font-medium"><span className="lang-th">ไม่สะดวก (ขอทำที่บ้าน)</span><span className="lang-en">Not convenient (At-home only)</span></button>
                </div>

                <h3 className="text-[10px] font-medium text-wellnista-textMuted mb-2 tracking-wide uppercase"><span className="lang-th">3. ช่วงเวลาที่คุณว่างพักผ่อน</span><span className="lang-en">3. Free Time</span></h3>
                <div className="grid grid-cols-2 gap-2 mb-4" id="q-time">
                    <button onClick={(e) => {selectSingle('time', 'afterwork', e.currentTarget)}} className="option-btn p-3 rounded-2xl text-center text-[11px] font-medium"><span className="lang-th">หลังเลิกงานวันธรรมดา</span><span className="lang-en">Weekdays After Work</span></button>
                    <button onClick={(e) => {selectSingle('time', 'weekend', e.currentTarget)}} className="option-btn p-3 rounded-2xl text-center text-[11px] font-medium"><span className="lang-th">วันหยุดสุดสัปดาห์</span><span className="lang-en">Weekends</span></button>
                    <button onClick={(e) => {selectSingle('time', 'morning', e.currentTarget)}} className="option-btn p-3 rounded-2xl text-center text-[11px] font-medium"><span className="lang-th">ตอนเช้าก่อนเริ่มงาน</span><span className="lang-en">Mornings Before Work</span></button>
                    <button onClick={(e) => {selectSingle('time', 'random', e.currentTarget)}} className="option-btn p-3 rounded-2xl text-center text-[11px] font-medium"><span className="lang-th">ไม่แน่นอนจัดสรรยาก</span><span className="lang-en">Irregular / Hard to plan</span></button>
                </div>

                <div className="flex gap-2 mt-auto pt-4">
                    <button onClick={(e) => {nextStep(5)}} className="w-1/3 bg-white border border-wellnista-border text-wellnista-textDark font-medium py-3 rounded-[20px] hover:bg-slate-50 transition-colors"><span className="lang-th">กลับ</span><span className="lang-en">Back</span></button>
                    <button onClick={(e) => {processData()}} id="btn-next-6" className="w-2/3 bg-wellnista-olive hover:bg-wellnista-oliveDark text-white font-medium py-3 rounded-[20px] shadow-md disabled:opacity-40 disabled:shadow-none transition-all duration-300 flex justify-center items-center gap-2"><span className="lang-th">ประมวลผลด้วย AI</span><span className="lang-en">Process with AI</span> <i data-lucide="sparkles" className="w-4 h-4"></i></button>
                </div>
            </div>
            ...
            <div id="step-7" className="step flex-col items-center justify-center flex-1 text-center hidden">
                ...
                <div id="loading-sub" className="text-xs text-wellnista-textMuted font-light"><span className="lang-th">ประมวลผลข้อมูลร่างกายและจิตใจ</span><span className="lang-en">Processing physical and mental data</span></div>
            </div>
            ...
            <div id="step-8" className="step flex-col flex-1 hidden">
                ...
                <div id="warning-banner" className="hidden bg-rose-50 border border-rose-100 rounded-2xl p-4 mb-4 flex items-start gap-3 shrink-0">
                    ...
                    <div>
                        ...
                        <div className="text-[11px] text-rose-900/70 leading-relaxed font-light"><span className="lang-th">ระบบได้คัดกรองกิจกรรมที่อาจเสี่ยงต่อสุขภาพของคุณออก (PAR-Q+)</span><span className="lang-en">The system has filtered out activities that may pose health risks (PAR-Q+)</span></div>
                    </div>
                </div>
                ...
                <div id="home-banner" className="hidden bg-wellnista-sageLight border border-wellnista-sage/30 rounded-2xl p-4 mb-4 flex items-start gap-3 shrink-0">
                    ...
                    <div>
                        ...
                        <div className="text-[11px] text-wellnista-olive leading-relaxed font-light"><span className="lang-th">เน้นเฉพาะกิจกรรมที่คุณสามารถทำได้อย่างสะดวกที่บ้าน</span><span className="lang-en">Focusing exclusively on activities you can do at home</span></div>
                    </div>
                </div>
                ...
                <div className="mb-4 shrink-0">
                    <h3 className="text-[9px] font-medium text-wellnista-textMuted mb-2 tracking-wide uppercase"><span className="lang-th">ตัวเลือกอื่นๆ ที่เหมาะกับคุณ</span><span className="lang-en">Other Suitable Options</span></h3>
                ...
                <div className="mt-auto bg-[#faf8ec] rounded-[24px] p-5 text-center border-2 border-wellnista-gold/30 shadow-md animate-glow relative shrink-0">
                    ...
                    <h3 className="text-xs md:text-sm font-semibold mb-2 text-wellnista-textDark font-serif"><span className="lang-th">ประสบการณ์นี้ตรงใจคุณไหม?</span><span className="lang-en">Does this match your needs?</span></h3>
                    <p className="text-[9px] text-wellnista-textMuted mb-4"><span className="lang-th">โปรดให้คะแนนเพื่อดูผลวิเคราะห์ขั้นสุดท้าย</span><span className="lang-en">Please rate to see the final analysis</span></p>
            ...
            <div id="step-9" className="step flex-col flex-1 hidden">
                ...
                <h2 className="text-xl font-semibold mb-2 tracking-tight text-wellnista-textDark"><span className="lang-th">คุณคิดว่ากิจกรรมอื่นน่าจะเหมาะกับคุณมากกว่าไหม?</span><span className="lang-en">Do you think another activity would suit you better?</span></h2>
                <p className="text-wellnista-textMuted text-xs mb-4 font-light"><span className="lang-th">โปรดเลือกสิ่งที่คุณอยากทำที่สุดในตอนนี้ เพื่อสอน AI ให้รู้จักคุณมากขึ้น</span><span className="lang-en">Please select what you want to do most right now to help train the AI</span></p>
                <div className="flex-1 pb-4 w-full">
                    ...
                    <div className="grid grid-cols-1 gap-2" id="q-target-reason">
                        <button onClick={(e) => {selectSingle('targetReason', 'perfect', e.currentTarget)}} className="option-btn p-3 rounded-2xl text-left text-[10px] font-medium flex items-center gap-2"><i data-lucide="check-circle-2" className="w-4 h-4 text-wellnista-sage shrink-0"></i> <span className="lang-th">ผลลัพธ์ตรงกับความต้องการที่สุด</span><span className="lang-en">Recommendation perfectly matches my needs</span></button>
                        <button onClick={(e) => {selectSingle('targetReason', 'physical', e.currentTarget)}} className="option-btn p-3 rounded-2xl text-left text-[10px] font-medium flex items-center gap-2"><i data-lucide="activity-square" className="w-4 h-4 text-wellnista-sage shrink-0"></i> <span className="lang-th">บรรเทาอาการปวดเมื่อยทางกาย</span><span className="lang-en">Relieve physical aches</span></button>
                        <button onClick={(e) => {selectSingle('targetReason', 'mental', e.currentTarget)}} className="option-btn p-3 rounded-2xl text-left text-[10px] font-medium flex items-center gap-2"><i data-lucide="cloud-off" className="w-4 h-4 text-wellnista-sage shrink-0"></i> <span className="lang-th">ระบายความเครียด หนีความวุ่นวาย</span><span className="lang-en">Relieve stress, escape chaos</span></button>
                        <button onClick={(e) => {selectSingle('targetReason', 'stimulation', e.currentTarget)}} className="option-btn p-3 rounded-2xl text-left text-[10px] font-medium flex items-center gap-2"><i data-lucide="zap" className="w-4 h-4 text-wellnista-sage shrink-0"></i> <span className="lang-th">ต้องการพลังงาน ความท้าทายใหม่</span><span className="lang-en">Need energy, new challenges</span></button>
                        <button onClick={(e) => {selectSingle('targetReason', 'growth', e.currentTarget)}} className="option-btn p-3 rounded-2xl text-left text-[10px] font-medium flex items-center gap-2"><i data-lucide="users" className="w-4 h-4 text-wellnista-sage shrink-0"></i> <span className="lang-th">พัฒนาตัวเอง เรียนรู้และหาเพื่อนใหม่</span><span className="lang-en">Self-development, learn, meet friends</span></button>
                    </div>
                </div>

                <div className="mt-2 shrink-0">
                    <button onClick={(e) => {processUserChoice()}} id="btn-next-9" className="w-full bg-wellnista-olive hover:bg-wellnista-oliveDark text-white font-medium py-3 md:py-4 rounded-[20px] shadow-md disabled:opacity-40 disabled:shadow-none transition-all duration-300 flex items-center justify-center gap-2"><span className="lang-th">เสร็จสิ้น</span><span className="lang-en">Finish</span> <i data-lucide="check-circle" className="w-4 h-4"></i></button>
                </div>
            </div>
            ...
            <div id="step-10" className="step flex-col items-center justify-center flex-1 text-center hidden">
                ...
                <button onClick={(e) => {resetApp()}} className="w-full mt-auto bg-white border border-wellnista-border text-wellnista-textDark hover:bg-slate-50 rounded-[20px] py-4 font-medium text-sm transition-all duration-300 flex items-center justify-center gap-2 shadow-sm">
                    <i data-lucide="rotate-ccw" className="w-4 h-4"></i> <span className="lang-th">ทำแบบประเมินอีกครั้ง</span><span className="lang-en">Retake Assessment</span>
                </button>
            </div>
